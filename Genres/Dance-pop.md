A genre of popular dance music that originated in the early 1980s, combining pop song structures with danceable beats, synthesizers, and a strong rhythmic groove.
...
if (pages.length > 0) {
  ...
  for (const p of pages) {
    // Derive subfolder from file path: Artists/X/...
